...
> **Estado destacado FUNVISIS:** `fixture_only` | estrategia `fallback_proxy` | modo `usgs_proxy_for_funvisis`

## Catalogo sismico
- USGS: estado=available_raw, modo=layer_a_raw_and_processed, procesados=8001
- FUNVISIS: estado=fixture_only, modo=layer_a_fixture_and_processed, procesados=3
